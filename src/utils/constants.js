...
export const darkThemeColors = {
    text: { main: '#F6F6F6', appbar: '#F6F6F6', container: '#1A1A1A', input: '#232323', option: '#F6F6F6', yellow: 'rgba(243, 225, 107)', day: '#1A1A1A'},
...
export const lightThemeColors = {
    text: { main: '#1A1A1A', appbar: '#323232', container: '#1A1A1A', input: '#232323', option: '#232323', yellow: '#edd700', day: '#F6F6F6'},
    ...
    button: {toggle: 'rgb(255,192,203, .4)', toggleHover: 'rgb(255,192,203, .5)', toggleSelected: 'rgb(255,255,255, .6)', toggleSelectedHover: 'rgb(255,255,255)', heart: '#c697bf'},
